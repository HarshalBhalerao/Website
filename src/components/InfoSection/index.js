...
const InfoSection = ({lightBg, imgStart, id, lightText, headLine, darkText, description, buttonLabel, img, alt, primary, dark, buttonExist, langUsed, liExist, uiUsed, animationUsed }) => {
                    ...
                    <InfoRow imgStart = {imgStart}>
                        <Column1>
                            <TextWrapper>
                                ...
                                <List visible = {liExist ? 1 : 0}>{uiUsed}</List>
